###*
 * @deprecated Depreceated since too cluttered, new structure provided in smaller
 * controllers
 * @description Old Maps Controller...
 *
 * @todo strip old code, put logic in correct controllers
 *
